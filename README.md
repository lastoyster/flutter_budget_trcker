#Flutter Budget Tracker App With Notion API

Budget Tracker App with Flutter(BLoC Pattern) and the Notion API. How to use Notion's API to retrieve data, save data and delete data element. 
...
## Getting Started
 ...
 ```
 git clone https://github.com/lastoyster/flutter_budget_tracker.git
 ```  
